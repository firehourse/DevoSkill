...
## Load Order
1. Read `{DEVOSKILL_ROOT}/skills/devoskill-thinking-phase/SKILL.md`
...
- Hand control back to `{DEVOSKILL_ROOT}/skills/devoskill-planning/SKILL.md` once the key ambiguity has been reduced enough to write effective docs.
