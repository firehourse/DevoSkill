---
name: devoskill-thinking-phase
description: Thinking phase module for DevoSkill. Use to classify requests, model current reality, and confirm boundaries before planning.
---
