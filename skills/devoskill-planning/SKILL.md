...
description: Planning module for DevoSkill. Use when the task is architecture design, request analysis, task planning, or planning document generation.
---
...
4. After classifying the request, read exactly one of:
